module unsigned_max #(
    ...
    for(i=0; i<tree_depth; i++) begin : tree_max
    ...
    // Assign outputs.
    if(flop_output) begin : name7
        always_ff @(posedge i_clk) begin
            o_e_max <= p0_e_max;
        end
    end else begin : name8
